# Generated by Django 4.1 on 2022-12-17 20:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[], max_length=200, verbose_name='Language')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, max_length=254, null=True, validators=[extensions.utils.email_validator], verbose_name='Email')),
                ('avatar', models.ImageField(blank=True, null=True, upload_to='', verbose_name='avatar')),
                ('national_code', models.CharField(max_length=10, validators=[extensions.utils.national_code_validator], verbose_name='national_code')),
                ('passport_number', models.CharField(blank=True, max_length=20, null=True, verbose_name='passport_number')),
                ...
                ('month_of_birth', models.PositiveIntegerField(validators=[django.core.validators.MaxValueValidator(12)], verbose_name='day of birth')),
                ('year_of_birth', models.PositiveIntegerField(validators=[django.core.validators.RegexValidator(message='The year is Invalid.', regex='^1[34]\\d{2}$')], verbose_name='day of birth')),
                ('military_service_status', models.CharField(blank=True, choices=[('دارای کارت پایان خدمت', 'دارای کارت پایان خدمت'), ('در حال خدمت', 'در حال خدمت'), ('معاف از رزم', 'معاف از رزم'), ('معافیت تحصیلی', 'معافیت تحصیلی'), ('معافیت پزشکی', 'معافیت پزشکی'), ('سایر معافیت ها', 'سایر معافیت ها')], max_length=100, null=True, verbose_name='Military Service Status')),
                ('other_exemptions', models.CharField(blank=True, max_length=100, null=True, verbose_name='other exemptions')),
                ('about_me', models.TextField(blank=True, max_length=500, null=True, verbose_name='About Me')),
                ('cv_file', models.FileField(blank=True, null=True, upload_to='', verbose_name='CV File')),
                ('educational_record', models.OneToOneField(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.educationalrecord')),
                ('language', models.OneToOneField(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.language')),
                ('user', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('work_experience', models.OneToOneField(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.workexperience')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('english_name', models.CharField(blank=True, max_length=120, null=True, unique=True, verbose_name='english name')),
                ...
                ('industry', models.ManyToManyField(to='accounts.industry', verbose_name='industry')),
                ('organizational_interface', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='organizational interface')),
            ],
            options={
