    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=120, verbose_name='title')),
                ('industry', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.industry', verbose_name='childs')),
            ],
            options={
                'verbose_name': 'Industry Child',
                'verbose_name_plural': 'Industry Childs',
            },
        ),
        migrations.CreateModel(
            name='CompanyProfile',
            fields=[
                ...
                ('industry', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.industry', verbose_name='industry')),
